...
urlpatterns = [
    ...
    path('registrations/<uuid:registration_id>/generate-participant-id/', admin_views.generate_participant_id_view, name='generate_participant_id'),
    ...
    path('settings/program/add/', admin_views.add_program, name='add_program'),
    path('settings/program/<int:program_id>/edit/', admin_views.edit_program, name='edit_program'),
    path('settings/program/<int:program_id>/delete/', admin_views.delete_program, name='delete_program'),
